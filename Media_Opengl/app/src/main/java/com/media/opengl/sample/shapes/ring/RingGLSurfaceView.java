...
import com.media.opengl.sample.R;
...
public class RingGLSurfaceView extends GLSurfaceView {
    ...
    public RingGLSurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            cylinder = new RingShape(12f, 12f, 10f, 2f, textureId);//创建圆柱体
